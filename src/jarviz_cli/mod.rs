use crate::jarviz_cli::bytecode::{
    get_major_version, resolve_gradle_dependencies, resolve_pom_dependencies,
};
...
pub fn get_output_format(command_matches: &clap::ArgMatches) -> String {
    command_matches
